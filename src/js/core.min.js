...
// function loadGrid(a) {
//     "datagrid" == $.cookie("gridType") ? $("#" + $.cookie("gridId")).datagrid("load", {advanceFilter: JSON.stringify(a)}) : "treegrid" == $.cookie("gridType") && $("#" + $.cookie("gridId")).treegrid("load", {advanceFilter: JSON.stringify(a)})
// }
...
function timestamp2Datetime(a, b) {
    var c, d = new Date(a), e = d.getFullYear(), f = d.getMonth() + 1 < 10 ? "0" + (d.getMonth() + 1) : d.getMonth() + 1, g = d.getDate() < 10 ? "0" + d.getDate() : d.getDate(), h = d.getHours() < 10 ? "0" + d.getHours() : d.getHours(), i = d.getMinutes() < 10 ? "0" + d.getMinutes() : d.getMinutes(), j = d.getSeconds() < 10 ? "0" + d.getSeconds() : d.getSeconds();
...
function addTab(a) {
    var b = '<iframe src="' + a.url + '" scrolling="auto" frameborder="0" style="width:100%;height:100%;"></iframe>', c = $("#index_tabs"), d = {
        id: Math.random(),
        title: a.text,
...
function openDialogAndloadDataByParentGrid(a) {
    ...
    if (!a.dialog.beforeOpenCheckUrl || beforeOpenCheck(replaceUrlParamValueByBrace(a.dialog.beforeOpenCheckUrl, d))) {
        ...
        if (a.dialog.href.indexOf("{") != -1) {
            ...
            e.iDialog({href: g}), e.iDialog("open")
        } else e.iDialog("open")
    }
}
...
//     var d;
//     return "datagrid" == a ? d = c ? $("#" + b).datagrid("getSelections") : $("#" + b).datagrid("getSelected") : "treegrid" == a && (d = c ? $("#" + b).treegrid("getSelections") : $("#" + b).treegrid("getSelected")), d
// }
...
function refreshGrid(a, b, c) {
    "datagrid" == a ? (1 == c && $("#" + b).datagrid({queryParams: {clearQueryParams: ""}}), $("#" + b).datagrid("reload"), $("#" + b).datagrid("unselectAll")) : "treegrid" == a && ($("#" + b).treegrid("reload"), $("#" + b).treegrid("unselectAll"))
}
...
function doAjaxHandler(a) {
    var b = $.data(a, "menubutton").options, c = {
        ...
        grid: {uncheckedMsg: topJUI.language.message.msg.checkSelfGrid}
    };
    if (b = $.extend({}, c, b), b.url = appendSourceUrlParam(b.url), b.url.indexOf("{parent") != -1) {
...
function filterHandler(a) {
    var b = $.data(a, "menubutton").options;
    if ("object" == typeof b.grid) {
        var c = b.grid.id, d = $("#" + c).datagrid("options"), e = d.filter ? d.filter : [];
    ...
    f.dialog(b.dialog), $("#resetAdvanceSearchForm").linkbutton({
        ...
        onClick: function () {
            for (var a = [], c = $("#" + b.dialog.id).serializeArray(), d = c.length / 6, e = 0; e < d; e++) {
                var f = (c[6 * e + 0].name, c[6 * e + 0].value), g = (c[6 * e + 1].name, c[6 * e + 1].value), h = (c[6 * e + 2].name, c[6 * e + 2].value), i = (c[6 * e + 3].name, c[6 * e + 3].value), j = (c[6 * e + 4].name, c[6 * e + 4].value), k = (c[6 * e + 5].name, c[6 * e + 5].value);
...
function importHandler(a) {
    var b = $.data(a, "menubutton").options;
    if ("object" == typeof b.grid) {
        getColumnsNameAndField(b.grid.type, b.grid.id);
        var c = $("#importExcelDialog");
        c.dialog({
            title: "导入Excel数据",
            iconCls: "icon-find",
...
function edatagridHandler(a) {
    var b = $.data(a, "menubutton").options;
    "addRow" == b.type && $("#" + b.grid.id).edatagrid("addRow", 0), "saveRow" == b.type && $("#" + b.grid.id).edatagrid("saveRow"), "cancelRow" == b.type && $("#" + b.grid.id).edatagrid("cancelRow"), "destroyRow" == b.type && $("#" + b.grid.id).edatagrid("destroyRow")
}
function getColumnsNameAndField(a, b) {
    var c = [], d = [], e = [], f = [];
    if ("datagrid" == a) {
        c = $("#" + b).datagrid("getColumnFields", !0), d = $("#" + b).datagrid("getColumnFields"), e = c.concat(d);
        for (var g = 0; g < e.length; g++) {
            var h = $("#" + b).datagrid("getColumnOption", e[g]);
            f.push(h.title)
        }
    } else if ("treegrid" == a) {
        c = $("#" + b).treegrid("getColumnFields", !0), d = $("#" + b).treegrid("getColumnFields"), e = c.concat(d);
        for (var i = 0; i < e.length; i++) {
            var h = $("#" + b).treegrid("getColumnOption", e[i]);
            f.push(h.title)
        }
    }
    var j = f.join(",").replace(/,操作/g, "").replace(/操作,/g, ""), k = e.join(",").replace(/,handle/g, "").replace(/handle,/g, "");
    $.cookie("gridId", b), $.cookie("gridType", a), $.cookie("colNameStr", j), $.cookie("fieldNameStr", k)
}
function exportHandler(a) {
    ...
    var o = j.join(",").replace(/,操作/g, "").replace(/操作,/g, ""), p = h.join(",").replace(/,handle/g, "").replace(/handle,/g, "");
    b.ajaxData = {
...
function doAjax(a) {
    ...
    return a = $.extend(c, a), $.ajax({
        ...
        success: function (c, d, e) {
            $.messager.progress("close"), refreshGrids(a.reload), 1 == c.statusCode || 100 == c.statusCode || 200 == c.statusCode ? (b.statusCode = 200, b.title = c.title, b.message = c.message) : 1 == c ? (b.statusCode = 200, b.title = "操作提示", b.message = "操作成功！") : (b.statusCode = 300, b.title = c.title, b.message = c.message)
        }
    }), b
}
...
function replaceUrlParamValueByBrace(a, b, c) {
    var d = a;
    if (a && a.indexOf("{") >= 0) {
        var e = isMultiObj(b) ? b[0] : b, f = isNull(c) ? "" : c + ".", g = new RegExp("{" + f + "(.*?)}", "g"), h = a.match(g);
...
//     var d = a;
//     if (a && a.indexOf("{") >= 0) {
//         var e = {}, f = isMultiObj(b) ? b[0] : b, g = isNull(c) ? "" : c + ".", h = new RegExp("{" + g + "(.*?)}", "g"), i = a.match(h);
...
var scripts = document.getElementsByTagName("script"), lastScript = scripts[scripts.length - 1], scriptSrc = lastScript.src, _tjp = scriptSrc.substring(0, scriptSrc.lastIndexOf("/")).replace("js", ""), _ctx = _tjp.replace("topjui/", "");
$.getUrlParam = function (a) {
    ...
    a.easyui = {
        ...
        function e(b, c, d, e) {
            var f = a(b), g = c, h = g.substr(0, 1).toUpperCase() + g.substr(1), i = a.parser.parseValue("min" + h, e["min" + h], d), j = a.parser.parseValue("max" + h, e["max" + h], d), k = a.parser.parseValue(g, e[g], d), l = String(e[g] || "").indexOf("%") >= 0;
    ...
    function e(d) {
        ...
        return e.droppables.each(function () {
            ...
            if (!b.droppable("options").disabled) {
                var c = b.offset();
                d.pageX > c.left && d.pageX < c.left + b.outerWidth() && d.pageY > c.top && d.pageY < c.top + b.outerHeight() ? (this.entered || (a(this).trigger("_dragenter", [f]), this.entered = !0), a(this).trigger("_dragover", [f])) : this.entered && (a(this).trigger("_dragleave", [f]),
                    this.entered = !1)
            }
        }), !1
    }
    ...
    a.fn.resizable = function (b, c) {
        ...
        function g(b) {
            return d(b), 0 != a.data(b.data.target, "resizable").options.onResize.call(b.data.target, b) && e(b), !1
        }
        ...
        return "string" == typeof b ? a.fn.resizable.methods[b](this, c) : this.each(function () {
            ...
            e ? (a(this).unbind(".resizable"), d = a.extend(e.options, b || {})) : (d = a.extend({}, a.fn.resizable.defaults, a.fn.resizable.parseOptions(this), b || {}), a.data(this, "resizable", {options: d})), 1 != d.disabled && a(this).bind("mousemove.resizable", {target: this}, function (b) {
    ...
    a.fn.tree = function (d, e) {
        ...
        function c(b, d) {
            d.children("li").each(function () {
                var d = a(this), e = a.extend({}, a.parser.parseOptions(this, ["id", "iconCls", "state"]), {checked: !!d.attr("checked") || void 0});
    ...
    var Q = 1, R = {
        render: function (b, c, d) {
            ...
            var f = a.data(b, "tree"), g = f.options, h = a(c).prev(".tree-node"), i = h.length ? a(b).tree("getNode", h[0]) : null, j = h.find("span.tree-indent, span.tree-hit").length, k = e.call(this, j, d);
            a(c).append(k.join(""))
    ...
    function _211(a, b) {
        var c = $.data(a, "panel"), d = c.options, e = c.panel, f = e.children(".panel-header"), g = e.children(".panel-body"), h = e.children(".panel-footer"), i = "left" == d.halign || "right" == d.halign;
        if (b && $.extend(d, {
                width: b.width,
                height: b.height,
                minWidth: b.minWidth,
            ...
            g.css("height", "");
            var j = $.parser.parseValue("minHeight", d.minHeight, e.parent()), k = $.parser.parseValue("maxHeight", d.maxHeight, e.parent()), l = f._outerHeight() + h._outerHeight() + e._outerHeight() - e.height();
    ...
    function _223(a) {
        ...
        return b[0].appendChild(a), b.bind("_resize", function (b, c) {
            return ($(this).hasClass("easyui-fluid") || c) && _211(a), !1
        }), b
    }

    function _227(_228) {
        function _22b() {
            if (opts.noheader || !opts.title && !opts.header)_210(_22a.children(".panel-header")), _22a.children(".panel-body").addClass("panel-body-noheader"); else {
                if (opts.header)$(opts.header).addClass("panel-header").prependTo(_22a); else {
                    ...
                    opts.iconCls && (_230.addClass("panel-with-icon"), $('<div class="panel-icon"></div>').addClass(opts.iconCls).appendTo(_22f)), "left" != opts.halign && "right" != opts.halign || _230.addClass("panel-title-" + opts.titleDirection);
    ...
    function _23d(a, b) {
        function c() {
            ...
            b.length && (d.maximized = !0), d.onOpen.call(a), 1 == d.maximized && (d.maximized = !1, _241(a)), 1 == d.collapsed && (d.collapsed = !1, _242(a)), d.collapsed || (_233(a), _23b(a))
        }
    ...
    function _242(a, b) {
        ...
        var d = $.data(a, "panel").options, e = $.data(a, "panel").panel, f = e.children(".panel-body"), g = e.children(".panel-header"), h = g.find("a.panel-tool-collapse");
    ...
    function _251(a, b) {
        function c() {
            f.show(), d.collapsed = !1, d.onExpand.call(a), _233(a), _23b(a)
        }

        var d = $.data(a, "panel").options, e = $.data(a, "panel").panel, f = e.children(".panel-body"), g = e.children(".panel-header").find("a.panel-tool-collapse");
    ...
    $(window).unbind(".panel").bind("resize.panel", function () {
        ...
        return "string" == typeof a ? $.fn.panel.methods[a](this, b) : (a = a || {}, this.each(function () {
            ...
            c ? (b = $.extend(c.options, a), c.isLoaded = !1) : (b = $.extend({}, $.fn.panel.defaults, $.fn.panel.parseOptions(this), a), $(this).attr("title", ""), c = $.data(this, "panel", {
                ...
                panel: _223(this),
                isLoaded: !1
            })), _227(this), $(this).show(), 1 == b.doSize && (c.panel.css("display", "block"), _211(this)), 1 == b.closed || 1 == b.minimized ? c.panel.hide() : _23d(this)
        }))
    }, $.fn.panel.methods = {
        options: function (a) {
            ...
            return a.each(function () {
                ...
                a.isLoaded = !1, b && ("string" == typeof b ? a.options.href = b : a.options.queryParams = b), _233(this)
            })
        }, resize: function (a, b) {
            return a.each(function () {
                _211(this, b)
    ...
    function g(b) {
        function c(b) {
            g.pmask && g.pmask.remove(), g.pmask = a('<div class="window-proxy-mask"></div>').insertAfter(g.window), g.pmask.css({
                ...
                display: "none", zIndex: a.fn.window.defaults.zIndex++, left: b.data.left, top: b.data.top
    ...
    function _2a7(_2a8) {
        ...
        opts.inited = !1, $(_2a8).window($.extend({}, opts, {
            onResize: function (a, b) {
        ...
        } else $(opts.toolbar).addClass("dialog-toolbar").appendTo(win), $(opts.toolbar).show(); else $(_2a8).siblings("div.dialog-toolbar").remove();
        ...
        } else $(opts.buttons).addClass("dialog-button").appendTo(win), $(opts.buttons).show(); else $(_2a8).siblings("div.dialog-button").remove();
        opts.inited = !0;
    ...
    $.fn.dialog = function (a, b) {
        ...
        return a = a || {}, this.each(function () {
            ...
            b ? $.extend(b.options, a) : $.data(this, "dialog", {options: $.extend({}, $.fn.dialog.defaults, $.fn.dialog.parseOptions(this), a)}), _2a7(this)
        })
    }, $.fn.dialog.methods = {
        options: function (a) {
    ...
    function b(b, c) {
        ...
        var e = a.data(b, "accordion"), f = e.options, g = e.panels, h = a(b), i = "left" == f.halign || "right" == f.halign;
    ...
    function i(c) {
        ...
        e.addClass("accordion"), d.panels = [], e.children("div").each(function () {
            var b = a.extend({}, a.parser.parseOptions(this), {selected: !!a(this).attr("selected") || void 0}), e = a(this);
    ...
    function _32a(a) {
        ...
        if ("left" != b.tabPosition && "right" != b.tabPosition && b.showHeader) {
            ...
            var i = _329(c.find("ul.tabs")), j = c.width() - d._outerWidth();
    ...
    function _332(_333) {
        ...
        if (opts.tools)if ("string" == typeof opts.tools)$(opts.tools).addClass("tabs-tool").appendTo(_334), $(opts.tools).show(); else {
    ...
    function _342(a) {
        var b = $.data(a, "tabs").options, c = _344(a);
        if (c) {
    ...
    function _348(a) {
        ...
        b.children("div").each(function () {
            ...
            return ($(this).hasClass("easyui-fluid") || c) && (_336(a), _342(a)), !1
        })
    }
        ...
        $(a).children("div.tabs-header").unbind().bind("click", function (e) {
            if ($(e.target).hasClass("tabs-scroller-left"))$(a).tabs("scrollBy", -d.scrollIncrement); else {
                if (!$(e.target).hasClass("tabs-scroller-right")) {
                    ...
                    if (g.length)_370(a, b(f)); else if (f.length) {
    ...
    function _357(a, b, c) {
        ...
        var f = $(a).children("div.tabs-header").find("ul.tabs"), g = $(a).children("div.tabs-panels"), h = $('<li><a href="javascript:;" class="tabs-inner"><span class="tabs-title"></span><span class="tabs-icon"></span></a></li>');
        c || (c = $("<div></div>")), b.index >= e.length ? (h.appendTo(f), c.appendTo(g), e.push(c)) : (h.insertBefore(f.children("li:eq(" + b.index + ")")), c.insertBefore(g.children("div.panel:eq(" + b.index + ")")), e.splice(b.index, 0, c)), c.panel($.extend({}, b, {
            ...
            onBeforeOpen: function () {
                ...
                i.css("display", "block"), _342(a), i.css("display", "none")
            },
            onOpen: function () {
                b.onOpen && b.onOpen.call(this);
                var c = $(this).panel("options");
                d.selectHis.push(c.title), d.options.onSelect.call(a, c.title, _362(a, this))
            },
            onBeforeClose: function () {
    ...
    function _363(a, b) {
        var c = $.data(a, "tabs"), d = c.options;
        void 0 == b.selected && (b.selected = !0), _357(a, b), d.onAdd.call(a, b.title, b.index), b.selected && _367(a, b.index)
    }
    ...
    function _368(a, b) {
        ...
        e.disabled ? e.tab.addClass("tabs-disabled") : e.tab.removeClass("tabs-disabled"), _336(a), $.data(a, "tabs").options.onUpdate.call(a, e.title, _362(a, d))
    }

    function _370(a, b) {
        var c = $.data(a, "tabs").options, d = $.data(a, "tabs").tabs, e = $.data(a, "tabs").selectHis;
        if (_374(a, b)) {
            var f = _375(a, b), g = f.panel("options").title, h = _362(a, f);
            if (0 != c.onBeforeClose.call(a, g, h)) {
                var f = _375(a, b, !0);
                f.panel("options").tab.remove(), f.panel("destroy"), c.onClose.call(a, g, h), _336(a);
    ...
    $.fn.tabs = function (a, b) {
        return "string" == typeof a ? $.fn.tabs.methods[a](this, b) : (a = a || {}, this.each(function () {
            ...
            b ? $.extend(b.options, a) : ($.data(this, "tabs", {
                ...
                tabs: [],
                selectHis: []
            }), _348(this)), _332(this), _353(this), _336(this), _34c(this), _37e(this)
        }))
    }, $.fn.tabs.methods = {
        options: function (a) {
            var b = a[0], c = $.data(b, "tabs").options, d = _344(b);
            return c.selected = d ? _362(b, d) : -1, c
        }, tabs: function (a) {
            return $.data(a[0], "tabs").tabs
        }, resize: function (a, b) {
            return a.each(function () {
                _336(this, b), _342(this)
            })
        }, add: function (a, b) {
            return a.each(function () {
                _363(this, b)
    ...
    function d(c, d, e) {
        function g(b) {
            var d = "expand" + l.substring(0, 1).toUpperCase() + l.substring(1), e = i.center, f = "north" == l || "south" == l ? "minHeight" : "minWidth", g = "north" == l || "south" == l ? "maxHeight" : "maxWidth", j = "north" == l || "south" == l ? "_outerHeight" : "_outerWidth", k = a.parser.parseValue(g, i[l].panel("options")[g], a(c)), m = a.parser.parseValue(f, e.panel("options")[f], a(c)), n = e.panel("panel")[j]() - m;
            ...
            m.panel("options").split && p.addClass("layout-split-" + l), p.resizable(a.extend({}, {
                ...
                onResize: function (b) {
                    if ("north" == l || "south" == l) {
                        ...
                        var e = a(">div.layout-split-proxy-v", c), f = "north" == l ? b.data.height - e.height() : a(c).height() - b.data.height;
                        e.css("top", f)
                    } else {
                        var h = g(this);
                        a(this).resizable("options").maxWidth = h;
                        var e = a(">div.layout-split-proxy-h", c), i = "west" == l ? b.data.width - e.width() : a(c).width() - b.data.width;
                        e.css("left", i)
                    }
                    return !1
                },
    ...
    function f(b, c, d) {
        function e(d) {
            var e = {
                ...
                north: "down",
                south: "up"
            }, f = "north" == m.region || "south" == m.region, h = "layout-button-" + e[d], i = a("<div></div>").appendTo(b);
            if (i.panel(a.extend({}, a.fn.layout.paneldefaults, {
                    ...
                    onResize: function () {
                        ...
                        if (b.length) {
                            ...
                            var c = (a(this).width() - Math.min(b._outerWidth(), b._outerHeight())) / 2, d = Math.max(b._outerWidth(), b._outerHeight());
    ...
    function _41d(a, b) {
        ...
        c.data("menu") || c.data("menu", {options: $.parser.parseOptions(c[0], ["width", "height"])}), c.hasClass("menu-content") || (c.children("div").each(function () {
            _41f(a, this)
        }), $('<div class="menu-line"></div>').prependTo(c)), _420(a, c), c.hasClass("menu-inline") || c.hide(), _421(a, c)
    }

    function _41f(_422, div, _423) {
        var item = $(div), _424 = $.extend({}, $.parser.parseOptions(item[0], ["id", "name", "iconCls", "href", {separator: "boolean"}]), {
    ...
    function _420(a, b) {
        ...
        if (isNaN(parseInt(h)))if (h = i, b.hasClass("menu-top") && c.alignTo) {
            var j = $(c.alignTo), k = j.offset().top - $(document).scrollTop(), l = $(window)._outerHeight() + $(document).scrollTop() - j.offset().top - j._outerHeight();
    ...
    function _43c(a) {
        ...
        if (c.length) {
            ...
            c[0].submenu || (_436(b, d.inline), e.href && (location.href = e.href)), c.trigger("mouseenter"), d.onClick.call(b, $(b).menu("getItem", c[0]))
        }
    }

    function _436(a, b) {
        var c = $.data(a, "menu");
        return c && $(a).is(":visible") && (_416($(a)), b ? $(a).show() : c.options.onHide.call(a)), !1
    }
    ...
    function _44f(a, b) {
        ...
        if (b.parent) {
            if (!b.parent.submenu) {
                ...
                b.parent.submenu = d, $('<div class="menu-rightarrow"></div>').appendTo(b.parent), _41d(a, d)
            }
            c = b.parent.submenu
        }
    ...
    function _4cf(_4d0) {
        ...
        function _4d3() {
            ...
            if (opts.required && "" == opts.val(_4d0))return _4d4(opts.missingMessage), !1;
    ...
    $.fn.validatebox = function (a, b) {
        return "string" == typeof a ? $.fn.validatebox.methods[a](this, b) : (a = a || {}, this.each(function () {
            ...
            b ? $.extend(b.options, a) : (init(this), b = $.data(this, "validatebox", {options: $.extend({}, $.fn.validatebox.defaults, $.fn.validatebox.parseOptions(this), a)})), b.options._validateOnCreate = b.options.validateOnCreate, _4de(this, b.options.disabled), _4e1(this, b.options.readonly), _4ba(this), _4cf(this)
        }))
        ...
        options: function (a) {
            ...
            return a.each(function () {
                ...
                a._validateOnCreate = a.validateOnCreate, _4cf(this)
            })
        }, enable: function (a) {
            return a.each(function () {
            ...
            return a.each(function () {
                _4e1(this, b), _4ba(this), _4cf(this)
            })
        }
        ...
        validateOnBlur: !1,
        events: {
            focus: _4bd, blur: _4c1, mouseenter: _4c4, mouseleave: _4c7, click: function (a) {
                var b = $(a.data.target);
    ...
    function e(b, c) {
        ...
        var k = h.is(":visible");
        k || h.appendTo("body");
        var l = h.find(".textbox-text"), m = h.find(".textbox-button"), n = h.find(".textbox-addon"), o = n.find(".textbox-icon");
        "auto" == g.height && l.css({
            margin: "",
            paddingTop: "",
            paddingBottom: "",
        ...
        var p = h.width() - o.length * g.iconWidth - e("left") - e("right"), q = "auto" == g.height ? l.outerHeight() : h.height() - e("top") - e("bottom");
    ...
    function h(b, c) {
        var d = a.data(b, "textbox"), e = d.options, f = d.textbox, g = f.find(".textbox-text"), h = a(b).add(f.find(".textbox-value"));
    ...
    a.fn.textbox = function (d, f) {
        ...
        options: function (b) {
            ...
            var c = a.data("textbox"), d = c.options, e = c.textbox, f = e.find(".textbox-text"), b = b || d.tipPosition, g = e.offset(), h = f.offset(), i = e.outerWidth(), j = f.outerWidth();
            return "right" == b ? i - j - h.left + g.left : "left" == b ? g.left - h.left : (i - j - h.left + g.left) / 2 - (h.left - g.left) / 2
        }, getTipY: function (a, b) {
            var c = a.data("textbox"), d = c.options, e = c.textbox, f = e.find(".textbox-text"), b = b || d.tipPosition, g = e.offset(), h = f.offset(), i = e.outerHeight(), j = f.outerHeight();
        ...
        if (a(b).addClass("spinner-f").textbox(a.extend({}, e, {
                icons: f, doSize: !1, onResize: function (b, c) {
                    if (!e.spinArrow) {
                        ...
                        if (f.length) {
                            var g = f.outerWidth(), h = f.outerHeight(), i = d.find(".spinner-button." + e.clsLeft), j = d.find(".spinner-button." + e.clsRight);
            ...
            var i = a('<a href="javascript:;" class="textbox-button spinner-button"></a>').addClass(e.clsLeft).appendTo(d.spinner), j = a('<a href="javascript:;" class="textbox-button spinner-button"></a>').addClass(e.clsRight).appendTo(d.spinner);
            i.linkbutton({
    ...
    function f(b, c) {
        var e = a.data(b, "timespinner").options, f = a(b).timespinner("getValue"), g = e.selections[e.highlight], h = f.substring(0, g[0]), i = f.substring(g[0], g[1]), j = f.substring(g[1]), k = h + ((parseInt(i, 10) || 0) + e.increment * (c ? -1 : 1)) + j;
    ...
    function _67d(a, b) {
        ...
        f.body2.children("table.datagrid-btable-frozen").length || f.body1.add(f.body2).prepend('<table class="datagrid-btable datagrid-btable-frozen" cellspacing="0" cellpadding="0"></table>'), c(!0), c(!1), _65f(a)
    }
            ...
            return $(_685).children("thead").each(function () {
                ...
                $(this).find("tr").each(function () {
                    ...
                    $(this).find("th").each(function () {
                        var th = $(this), col = $.extend({}, $.parser.parseOptions(this, ["id", "field", "align", "halign", "order", "width", {
                            sortable: "boolean",
                            checkbox: "boolean",
                            resizable: "boolean",
                            fixed: "boolean"
    ...
    function _68d(_68e) {
        function _693(a, b, c) {
            if (b) {
                ...
                for (var i = $('<table class="datagrid-htable" border="0" cellspacing="0" cellpadding="0"><tbody></tbody></table>').appendTo(a), j = 0; j < b.length; j++)for (var k = $('<tr class="datagrid-header-row"></tr>').appendTo($("tbody", i)), l = b[j], m = 0; m < l.length; m++) {
                    var n = l[m], o = "";
                    n.rowspan && (o += 'rowspan="' + n.rowspan + '" '), n.colspan && (o += 'colspan="' + n.colspan + '" ', n.id || (n.id = ["datagrid-td-group" + _645, j, m].join("-"))), n.id && (o += 'id="' + n.id + '"');
                    ...
                    if (n.checkbox)p.attr("field", n.field), $('<div class="datagrid-header-check"></div>').html('<input type="checkbox"/>').appendTo(p); else if (n.field) {
                        ...
                        var q = p.find("div.datagrid-cell"), r = _646(f, n.field);
                        ...
                        q.css("text-align", n.halign || n.align || ""), n.cellClass = _68f.cellClassPrefix + "-" + n.field.replace(/[\.|\s]/g, "-"), q.addClass(n.cellClass)
        ...
        function _694() {
            for (var a = [[".datagrid-header-rownumber", opts.rownumberWidth - 1 + "px"], [".datagrid-cell-rownumber", opts.rownumberWidth - 1 + "px"]], b = _6a2(_68e, !0).concat(_6a2(_68e)), c = 0; c < b.length; c++) {
                var d = _6a3(_68e, b[c]);
                d && !d.checkbox && a.push(["." + d.cellClass, d.boxWidth ? d.boxWidth + "px" : "auto"])
            }
            _68f.ss.add(a), _68f.ss.dirty(_68f.cellSelectorPrefix), _68f.cellSelectorPrefix = "." + _68f.cellClassPrefix
        }
        ...
        if (_68f.ss = $(_68e).datagrid("createStyleSheet"), _690.panel($.extend({}, opts, {
            ...
            })), _68f.rowIdPrefix = "datagrid-row-r" + ++_645, _68f.cellClassPrefix = "datagrid-cell-c" + _645, _693(dc.header1, opts.frozenColumns, !0),
                _693(dc.header2, opts.columns, !1), _694(), dc.header1.add(dc.header2).css("display", opts.showHeader ? "block" : "none"), dc.footer1.add(dc.footer2).css("display", opts.showFooter ? "block" : "none"), opts.toolbar)if ($.isArray(opts.toolbar)) {
        ...
        } else $(opts.toolbar).addClass("datagrid-toolbar").prependTo(_690), $(opts.toolbar).show(); else $("div.datagrid-toolbar", _690).remove();
        if ($("div.datagrid-pager", _690).remove(), opts.pagination) {
            var _695 = $('<div class="datagrid-pager"></div>');
            if ("bottom" == opts.pagePosition)_695.appendTo(_690); else if ("top" == opts.pagePosition)_695.addClass("datagrid-pager-top").prependTo(_690); else {
            ...
            _695.pagination({
                ...
                onSelectPage: function (a, b) {
                    opts.pageNumber = a || 1, opts.pageSize = b, _695.pagination("refresh", {
                        pageNumber: a,
                        pageSize: b
                    }), _6df(_68e)
                }
    ...
    function _6a4(a) {
        ...
        var h = f.find("div.datagrid-cell"), i = "right" == d.resizeHandle ? "e" : "left" == d.resizeHandle ? "w" : "e,w";
        h.each(function () {
            $(this).resizable({
                handles: i,
                ...
                minWidth: 25,
                onStartResize: function (a) {
                    b.resizing = !0, f.css("cursor", $("body").css("cursor")), b.proxy || (b.proxy = $('<div class="datagrid-resize-proxy"></div>').appendTo(e.view)), b.proxy.css({
                ...
                onResize: function (a) {
                    return b.proxy.css({left: a.pageX - $(c).offset().left - 1, display: "block"}), !1
                },
                onStopResize: function (c) {
                    f.css("cursor", ""), $(this).css("height", "");
                    var e = $(this).parent().attr("field"), g = _6a3(a, e);
                    g.width = $(this)._outerWidth(), g.boxWidth = g.width - g.deltaWidth, g.auto = void 0, $(this).css("width", ""), $(a).datagrid("fixColumnSize", e), b.proxy.remove(), b.proxy = null, $(this).parents("div:first.datagrid-header").parent().hasClass("datagrid-view1") && _65f(a), $(a).datagrid("fitColumns"), d.onResizeColumn.call(a, e, g.width), setTimeout(function () {
                        b.resizing = !1
                    }, 0)
                }
            })
    ...
    function _6b2(a) {
        var b = _6b1(a.target), c = $(b).datagrid("options"), d = $(a.target).closest("input[type=checkbox]");
        if (d.length) {
            if (c.singleSelect && c.selectOnCheck)return !1;
            d.is(":checked") ? _6b4(b) : _6b5(b), a.stopPropagation()
        } else {
    ...
    function _6b7(a) {
        var b = _6b1(a.target), c = $(b).datagrid("options"), d = $(a.target).closest(".datagrid-cell");
        if (d.length) {
            var e = d.offset().left + 5, f = d.offset().left + d._outerWidth() - 5, g = "right" == c.resizeHandle ? a.pageX > f : "left" == c.resizeHandle ? a.pageX < e : a.pageX < e || a.pageX > f;
            if (g) {
                var h = d.parent().attr("field"), i = _6a3(b, h);
    ...
    function _6ba(a) {
        var b = _6b1(a.target), c = $(b).datagrid("options"), d = $(a.target).closest("td[field]");
    ...
    function _6c3(a) {
        var b = _6be(a.target);
        if (b) {
            var c = _6b1(b), d = $.data(c, "datagrid").options, e = _6c1(b), f = $(a.target);
            if (f.parent().hasClass("datagrid-cell-check"))d.singleSelect && d.selectOnCheck ? (f._propAttr("checked", !f.is(":checked")), _6c6(c, e)) : f.is(":checked") ? (f._propAttr("checked", !1), _6c6(c, e)) : (f._propAttr("checked", !0), _6c7(c, e)); else {
                var g = d.finder.getRow(c, e), h = f.closest("td[field]", b);
                if (h.length) {
                    var i = h.attr("field");
                    d.onClickCell.call(c, e, i, g[i])
                }
                if (1 == d.singleSelect)_6c9(c, e); else if (d.ctrlSelect)if (a.metaKey || a.ctrlKey)b.hasClass("datagrid-row-selected") ? _6ca(c, e) : _6c9(c, e); else if (a.shiftKey) {
                ...
                } else $(c).datagrid("clearSelections"), _6c9(c, e), d.lastSelectedIndex = e; else b.hasClass("datagrid-row-selected") ? _6ca(c, e) : _6c9(c, e);
    ...
    function _6cd(a) {
        var b = _6be(a.target);
        if (b) {
            var c = _6b1(b), d = $.data(c, "datagrid").options, e = _6c1(b), f = d.finder.getRow(c, e), g = $(a.target).closest("td[field]", b);
            if (g.length) {
                var h = g.attr("field");
    ...
    function _6d1(a) {
        var b = _6be(a.target);
        if (b) {
            var c = _6b1(b), d = $.data(c, "datagrid").options, e = _6c1(b), f = d.finder.getRow(c, e);
            d.onRowContextMenu.call(c, a, e, f)
        } else {
            var g = _6be(a.target, ".datagrid-body");
            if (g) {
                var c = _6b1(g), d = $.data(c, "datagrid").options;
    ...
    function _6b6(a, b) {
        ...
        if (0 != d.onBeforeSortColumn.call(a, e.sortName, e.sortOrder)) {
            ...
            d.remoteSort ? _6df(a) : _6e0(a, $(a).datagrid("getData")), d.onSortColumn.call(a, d.sortName, d.sortOrder)
        }
    }
    ...
    function _6ec(a) {
        ...
        function c() {
            var b = !1, c = _6a2(a, !0).concat(_6a2(a, !1));
            $.map(c, function (c) {
                var d = _6a3(a, c);
    ...
    function _70a(a, b) {
        ...
        if (f.css("table-layout", "fixed"), b)c(b); else for (var g = _6a2(a, !0).concat(_6a2(a, !1)), h = 0; h < g.length; h++)c(g[h]);
        f.css("table-layout", ""), _70f(a), _670(a), _710(a)
    }
    ...
    function _70f(a, b) {
        ...
        b = b || c.view.find("td.datagrid-td-merged"), b.each(function () {
            ...
            if (c > 1) {
                for (var d = _6a3(a, b.attr("field")), e = d.boxWidth + d.deltaWidth - 1, f = 1; f < c; f++)b = b.next(), d = _6a3(a, b.attr("field")), e += d.boxWidth + d.deltaWidth;
    ...
    function _6e0(a, b) {
        ...
        if (b = d.loadFilter.call(a, b), $.isArray(b) && (b = {
            ...
            b.rows.sort(function (b, c) {
                for (var d = 0, e = 0; e < f.length; e++) {
                    var h = f[e], i = g[e], j = _6a3(a, h), k = j.sorter || function (a, b) {
        ...
        if (h.length) {
            ...
            i.total != b.total && (h.pagination("refresh", {total: b.total}), d.pageNumber != i.pageNumber && i.pageNumber > 0 && (d.pageNumber = i.pageNumber, _6df(a)))
        }
        _670(a), e.body2.triggerHandler("scroll"), $(a).datagrid("setSelectionState"), $(a).datagrid("autoSizeColumn"), d.onLoadSuccess.call(a, b)
    }
    ...
    function _72d(a) {
        ...
        if (e.header1.add(e.header2).find("input[type=checkbox]")._propAttr("checked", !1), d.idField) {
            ...
            for (var i = d.finder.getRows(a), j = 0; j < i.length; j++) {
                ...
                b(c.selectedRows, k) && _6c9(a, l, !0, !0), b(c.checkedRows, k) && _6c6(a, l, !0)
            }
    ...
    function _6c6(a, b, c) {
        ...
        if (f && 0 != e.onBeforeCheck.apply(a, _649(a, [b, f]))) {
            e.singleSelect && e.selectOnCheck && (_6b5(a, !0), d.checkedRows = []), !c && e.selectOnCheck && _6c9(a, b, !0);
            ...
            e.idField && _648(d.checkedRows, e.idField, f), e.onCheck.apply(a, _649(a, [b, f]))
        }
    }
    ...
    function _6c7(a, b, c) {
        ...
        if (f && 0 != e.onBeforeUncheck.apply(a, _649(a, [b, f]))) {
            ...
            i.find("input[type=checkbox]")._propAttr("checked", !1), e.idField && _647(d.checkedRows, e.idField, f[e.idField]), e.onUncheck.apply(a, _649(a, [b, f]))
        }
    }
    ...
    function _773(a, b, c) {
        ...
        if (h.hasClass("datagrid-row-editing")) {
            if (!c) {
                ...
                }), j && _646(g, i) == -1 && _646(f, i) == -1 && f.push(i), e.onEndEdit.apply(a, _649(a, [b, i, k]))
            }
            h.removeClass("datagrid-row-editing"), _77f(a, b), $(a).datagrid("refreshRow", b), c ? e.onCancelEdit.apply(a, _649(a, [b, i])) : e.onAfterEdit.apply(a, _649(a, [b, i, k]))
        }
    }
    ...
    function _770(a, b) {
        ...
        d.children("td").each(function () {
            var b = $(this).find("div.datagrid-cell"), d = $(this).attr("field"), e = _6a3(a, d);
            if (e && e.editor) {
                var f, g;
    ...
    function _79b(a, b) {
        ...
        _646(f, h) >= 0 ? _647(f, h) : g.push(h), _647(c.selectedRows, d.idField, h[d.idField]), _647(c.checkedRows, d.idField, h[d.idField]), d.view.deleteRow.call(d.view, a, b), "auto" == d.height && _670(a), $(a).datagrid("getPager").pagination("refresh", {total: e.total})
    }
    ...
    function _7b4(a) {
        ...
        var m = b(i), n = b(j);
        i.splice(0, i.length), j.splice(0, j.length), k.total += h.length - g.length, k.rows = f, _6e0(a, k), c(m, "s"), c(n, "c"), _7ae(a)
    }
    ...
    function _6df(a, b, c) {
        ...
        if (d.pagination && $.extend(e, {
                page: d.pageNumber || 1,
                rows: d.pageSize
            }), d.sortName && $.extend(e, {sort: d.sortName, order: d.sortOrder}), 0 != d.onBeforeLoad.call(a, e)) {
            $(a).datagrid("loading");
    ...
    $.fn.datagrid = function (a, b) {
        return "string" == typeof a ? $.fn.datagrid.methods[a](this, b) : (a = a || {}, this.each(function () {
            ...
            if (_68d(this), _6a4(this), _65a(this), b.data)$(this).datagrid("loadData", b.data); else {
    ...
    $.fn.datagrid.methods = {
        options: function (a) {
            ...
            return a.each(function () {
                ...
                c.pagination("refresh", {pageNumber: 1}), _6df(this, b)
            })
        }, reload: function (a, b) {
            return a.each(function () {
                var a = $(this).datagrid("options");
                "string" == typeof b && (a.url = b, b = null), _6df(this, b)
            })
            ...
            return a.each(function () {
                ...
                b.splice(0, b.length), _74e(this), a.options.checkOnSelect && c.splice(0, c.length)
            })
        }, clearChecked: function (a) {
            return a.each(function () {
                var a = $.data(this, "datagrid"), b = a.selectedRows, c = a.checkedRows;
                c.splice(0, c.length), _6b5(this), a.options.selectOnCheck && b.splice(0, b.length)
            })
        }, scrollTo: function (a, b) {
            return a.each(function () {
                _73e(this, b)
            ...
            return a.each(function () {
                var a, c, d = this;
                "object" == typeof b ? (a = b.page, c = b.callback) : a = b, $(d).datagrid("options").pageNumber = a, $(d).datagrid("getPager").pagination("refresh", {pageNumber: a}), _6df(d, null, function () {
                    c && c.call(d, a)
                })
            })
        }
    ...
    var _826 = {
        render: function (a, b, c) {
            ...
            for (var g = $(a).datagrid("getColumnFields", d), h = ['<table class="datagrid-btable" cellspacing="0" cellpadding="0" border="0"><tbody>'], i = 0; i < c.length; i++) {
                var j = c[i], k = f.rowStyler ? f.rowStyler.call(a, b, j) : "", l = this.getStyleValue(k), m = 'class="datagrid-row ' + (b % 2 && f.striped ? "datagrid-row-alt " : " ") + l.c + '"', n = l.s ? 'style="' + l.s + '"' : "", o = e.rowIdPrefix + "-" + (d ? 1 : 2) + "-" + b;
            ...
            for (var i = 0; i < b.length; i++) {
                ...
                if (k) {
                    var l = e[j], m = k.styler ? k.styler.call(a, l, e, d) || "" : "", n = this.getStyleValue(m), o = n.c ? 'class="' + n.c + '"' : "", p = k.hidden ? 'style="display:none;' + n.s + '"' : n.s ? 'style="' + n.s + '"' : "";
            ...
            function e(c) {
                ...
                if (d.length) {
                    var e = $(a).datagrid("getColumnFields", c), h = d.find("div.datagrid-cell-check input[type=checkbox]").is(":checked");
            ...
            $.extend(g, c);
            var h = d.call(this, b), i = h.s, j = "datagrid-row " + (b % 2 && f.striped ? "datagrid-row-alt " : " ") + h.c;
            ...
            if (d && this.renderEmptyRow(a), c.emptyMsg && (b.dc.view.children(".datagrid-empty").remove(), d)) {
                var e = b.dc.header2.parent().outerHeight(), f = $('<div class="datagrid-empty"></div>').appendTo(b.dc.view);
    ...
    $.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, {
        ...
        rownumberWidth: 30,
        editorHeight: 24,
        headerEvents: {mouseover: _6ae(!0), mouseout: _6ae(!1), click: _6b2, dblclick: _6b7, contextmenu: _6ba},
        rowEvents: {mouseover: _6bc(!0), mouseout: _6bc(!1), click: _6c3, dblclick: _6cd, contextmenu: _6d1},
        ...
        if (d.length && d.parent().length) {
            ...
            if (c.hasClass("tree-hit"))y(f, e); else if (c.hasClass("tree-checkbox"))h(f, e); else {
                ...
                if (c.parent().hasClass("datagrid-cell-check") || i.singleSelect || !b.shiftKey)a.fn.datagrid.defaults.rowEvents.click(b); else {
                    var j = a(f).treegrid("getChildren"), k = a.easyui.indexOfArray(j, i.idField, i.lastSelectedIndex), l = a.easyui.indexOfArray(j, i.idField, e), m = Math.min(Math.max(k, 0), l), n = Math.max(k, l), o = j[l], p = c.closest("td[field]", d);
                    if (p.length) {
                        var q = p.attr("field");
    ...
    function o(b, e, f, g, h) {
        ...
        var l = v(b, e);
        if (l) {
            var m = j.finder.getTr(b, e, "body", 1), n = j.finder.getTr(b, e, "body", 2), o = m.next("tr.treegrid-tr-tree").children("td").children("div"), p = n.next("tr.treegrid-tr-tree").children("td").children("div");
            g || (l.children = [])
        } else {
    ...
    function u(b, c) {
        var d = a.data(b, "treegrid").options, e = d.finder.getTr(b, c), f = e.children('td[field="' + d.treeField + '"]');
    ...
    function C(b, c) {
        ...
        if (c.parent) {
            ...
            var g = f.children('td[field="' + e.treeField + '"]').children("div.datagrid-cell"), h = g.children("span.tree-icon");
        ...
        render: function (b, c, d) {
            function e(c, d, j) {
                for (var k = a(b).treegrid("getParent", j[0][f.idField]), l = (k ? k.children.length : a(b).treegrid("getRoots").length) - j.length, m = ['<table class="datagrid-btable" cellspacing="0" cellpadding="0" border="0"><tbody>'], n = 0; n < j.length; n++) {
                    ...
                    var p = f.rowStyler ? f.rowStyler.call(b, o) : "", q = this.getStyleValue(p), r = 'class="datagrid-row ' + (l++ % 2 && f.striped ? "datagrid-row-alt " : " ") + q.c + '"', s = q.s ? 'style="' + q.s + '"' : "", t = h + "-" + (c ? 1 : 2) + "-" + o[f.idField];
            ...
            for (var j = 0; j < c.length; j++) {
                ...
                if (l) {
                    var m = l.styler ? l.styler(f[k], f) || "" : "", n = this.getStyleValue(m), o = n.c ? 'class="' + n.c + '"' : "", p = l.hidden ? 'style="display:none;' + n.s + '"' : n.s ? 'style="' + n.s + '"' : "";
    ...
    a(function () {
        ...
        return c = c || {}, this.each(function () {
            ...
            d ? (a.extend(d.options, c), void 0 != c.value && (d.options.originalValue = c.value)) : (d = a.data(this, "combo", {
                ...
                previousText: ""
            }), d.options.originalValue = d.options.value), b(this), o(this)
        })
    }, a.fn.combo.methods = {
        options: function (b) {
            var c = b.textbox("options");
    ...
    function d(b, c) {
        ...
        var h = "div.combobox-item:visible:not(.combobox-item-disabled):first", i = "div.combobox-item:visible:not(.combobox-item-disabled):last";
            ...
            a.map(k, function (c) {
                ...
                for (var g = 0; g < m.length; g++) {
                    ...
                    if (h.filter.call(b, c, i)) {
                        var k = i[h.valueField], l = i[h.textField], o = i[h.groupField], p = h.finder.getEl(b, k).show();
        ...
        if (c) {
            ...
            if ("sticky" == d.groupPosition) {
                ...
                a(this).children(".combobox-group:visible").each(function () {
                    var b = a(this), g = d.finder.getGroup(c, b), h = f.data[g.startIndex + g.count - 1], i = d.finder.getEl(c, h[d.valueField]);
    ...
    a.fn.combobox = function (b, c) {
        ...
        function c(b, c) {
            var f = a(b), g = {};
            g[e.valueField] = void 0 != f.attr("value") ? f.attr("value") : f.text(), g[e.textField] = f.text(), g.selected = f.is(":selected"), g.disabled = f.is(":disabled"), c && (e.groupField = e.groupField || "group", g[e.groupField] = c), d.push(g)
        }
    ...
    a.fn.combobox.defaults = a.extend({}, a.fn.combo.defaults, {
        ...
        finder: {
            getEl: function (c, d) {
                ...
                var d = a.data(b, "combobox"), e = a.easyui.indexOfArray(d.groups, "value", c), f = d.groupIdPrefix + "_" + e;
                return a("#" + f)
            }, getGroup: function (b, c) {
                var d = a.data(b, "combobox"), e = c.attr("id").substr(d.groupIdPrefix.length + 1);
                return d.groups[parseInt(e)]
            }, getRow: function (c, d) {
                var e = a.data(c, "combobox"), f = d instanceof a ? d.attr("id").substr(e.itemIdPrefix.length + 1) : b(c, d);
    ...
    function d(b, c, d) {
        ...
        var g = a.data(b, "combotree"), h = g.options, i = g.tree, j = i.tree("options"), k = j.onBeforeCheck, l = j.onCheck, m = j.onSelect;
    ...
    function b(b) {
        ...
        function h() {
            var b = a(this), e = c(b), f = a(e).data("combogrid"), g = f.options, h = a.map(b.datagrid("getSelections"), function (a) {
                return a[g.idField]
            });
            h = h.concat(g.unselectedValues), d(e, h, f.remainText)
        }
        ...
        a(b).addClass("combogrid-f").combo(a.extend({}, j, {
            onShowPanel: function () {
                ...
                var b = a(this).combogrid("panel"), c = b.outerHeight() - b.height(), e = b._size("minHeight"), f = b._size("maxHeight"), g = a(this).combogrid("grid");
                g.datagrid("resize", {
                    width: "100%",
        ...
        function d(b) {
            ...
            if (!c.children("div.datebox-button").length) {
                for (var d = a('<div class="datebox-button"><table cellspacing="0" cellpadding="0" style="width:100%"><tr></tr></table></div>').appendTo(c), e = d.find("tr"), f = 0; f < h.buttons.length; f++) {
                    var g = a("<td></td>").appendTo(e), i = h.buttons[f], j = a('<a class="datebox-button-a" href="javascript:;"></a>').html(a.isFunction(i.text) ? i.text(b) : i.text).appendTo(g);
...
var openDialog = function (a) {
    ...
    if ("object" == typeof d)openDialogAndloadDataByParentGrid(b); else if (c.url)openDialogAndloadDataByUrl(b); else {
        "undefined" != c.onBeforeOpen && executeCallBackFun(c.onBeforeOpen, b), b.href = appendSourceUrlParam(c.href);
        var e = $("#" + c.id);
        if (e.iDialog(b.dialog), b.dialog.href.indexOf("{") != -1) {
            var f = getSelectedRowData(b.grid.type, b.grid.id), g = replaceUrlParamValueByBrace(appendSourceUrlParam(c.href), f);
            e.iDialog({href: g}), e.iDialog("open")
        } else e.iDialog("open")
    }
    ...
    c = e.title;
    var i = '<iframe src="' + b + '" frameborder="0" style="border:0;width:100%;height:100%;"></iframe>', j = parent.$("#index_tabs"), k = getSelectedTabOpts(j);
    j.iTabs("add", {
...
var defaultConfig = {
    config: {pkName: "uuid", singleQuotesParam: !1},
    language: {
        message: {
...
topJUI = $.extend(!0, defaultConfig, topJUI), function (a) {
    function b(b, c) {
        b.preventDefault();
    ...
    a.fn.iDatagrid = function (b, c) {
        ...
        this.each(function () {
            b = a.fn.iDatagrid.parseOptions(this, b), b.toolbar = "#" + b.id + "-toolbar", a(this).datagrid(b)
        })
        ...
        createGridHeaderContextMenu: b, singleSelectedAjax: function (b, c) {
            ...
            return null == d ? void a.messager.alert(topJUI.language.message.title.operationTips, topJUI.language.message.msg.selectSelfGrid, topJUI.language.message.icon.warning) : (c.url = replaceUrlParamValueByBrace(c.url, d), void a.messager.confirm(topJUI.language.message.title.confirmTips, c.confirmMsg, function (a) {
                if (a) {
                    var b = doAjax(c);
                    200 == b.statusCode && refreshGrid(c.grid.type, c.grid.id), showMessage(b)
                }
            }))
        }, multiSelectedAjax: function (b, c) {
            var d = getSelectedRowsData(c.grid.type, c.grid.id);
            return 0 == d.length ? void a.messager.alert(topJUI.language.message.title.operationTips, topJUI.language.message.msg.selectSelfGrid, topJUI.language.message.icon.warning) : void a.messager.confirm(topJUI.language.message.title.confirmTips, c.confirmMsg, function (a) {
                if (a) {
                    var b;
                    ...
                    var f = doAjax(c);
                    200 == f.statusCode && refreshGrid(c.grid.type, c.grid.id), showMessage(f)
                }
            })
        }, multiCheckedAjax: function (b, c) {
            var d = getCheckedRowsData(c.grid.type, c.grid.id);
            return 0 == d.length ? void a.messager.alert(topJUI.language.message.title.operationTips, c.grid.uncheckedMsg, topJUI.language.message.icon.warning) : void a.messager.confirm(topJUI.language.message.title.confirmTips, c.confirmMsg, function (a) {
                if (a) {
                    void 0 == c.grid.param && (c.grid.param = topJUI.config.pkName + ":" + topJUI.config.pkName), c.ajaxData = convertParamObj2ObjData(param2JsonObj(c.grid.param), d);
                    var b = doAjax(c);
                    200 == b.statusCode && refreshGrid(c.grid.type, c.grid.id), showMessage(b)
                }
            })
        ...
        onClickRow: function (b, c) {
            ...
            if ("object" == typeof d.childGrid) {
                ...
                for (var f = d.childGrid.grids, g = 0; g < f.length; g++)!function (b) {
                    setTimeout(function () {
                        var c = a("#" + f[b].id);
    ...
    a.fn.iDialog = function (b, c) {
        ...
        this.each(function () {
            b = a.fn.iDialog.parseOptions(this, b), b.href && (b.href = b.href + location.search), b.toolbar || (b.toolbar = "#" + b.id + "-toolbar"), b.buttons || (b.buttons = "#" + b.id + "-buttons"), b.top = .5 * a(document.body).height() - .5 * b.height, b.left = .5 * a(document.body).width() - .5 * b.width, a(this).dialog(b)
        })
        ...
        createDialog: function (b, c) {
            if (0 == a("#" + c.id).length) {
                ...
                a(".closeDialog").iLinkbutton({iconCls: "fa fa-close", btnCls: "topjui-btn-danger", text: "关闭"})
            }
        }
        ...
        onLoad: function () {
            ...
            if (b.mbId) {
                ...
                if ("object" == typeof d.parentGrid) {
                    var g = getSelectedRowData(d.parentGrid.type, d.parentGrid.id), h = getSelectedRowJson(d.parentGrid.param, g);
                    c.form("load", h)
                }
            }
        },
    ...
    a.fn.iNumberbox = function (b, c) {
        ...
        return setId(b, d)
    }, a.fn.iNumberbox.defaults = {width: 153, groupSeparator: ","}
}(jQuery), function (a) {
    a.fn.iNumberspinner = function (b, c) {
        ...
        return setId(b, d)
    }, a.fn.iNumberspinner.defaults = {width: 153, defaultValueType: ""}
}(jQuery), function (a) {
    ...
    "use strict";
    a(document).on(topJUI.eventType.initUI.form, function (b) {
        a('[data-toggle="topjui-switchbutton"]').each(function (b) {
            var c = a(this), d = getOptionsJson(c);
            c.iSwitchbutton(d)
            ...
            var c = a(this), d = getOptionsJson(c);
            d.readonly ? d.buttonText = "只读" : d.disabled && (d.buttonText = "禁止"), c.iTextbox(d)
            ...
            var c = a(this), d = getOptionsJson(c);
            c.iCombobox(d)
        }), a('[data-toggle="topjui-combotree"]').each(function (b) {
            var c = a(this), d = getOptionsJson(c);
            c.iCombotree(d)
        }), a('[data-toggle="topjui-combogrid"]').each(function (b) {
            var c = a(this), d = getOptionsJson(c);
            c.iCombogrid(d)
        }), a('[data-toggle="topjui-combotreegrid"]').each(function (b) {
            var c = a(this), d = getOptionsJson(c);
            c.iCombotreegrid(d)
            ...
            var c = a(this), d = getOptionsJson(c);
            d.multiline = !0, null == d.width && (d.width = 450), null == d.height && (d.height = 66), c.iTextbox(d)
        }), a('[data-toggle="topjui-autocomplete"]').each(function (b) {
            var c = a(this), d = getOptionsJson(c);
            c.iAutocomplete(d)
        }), a('[data-toggle="topjui-ueditor"]').each(function (b) {
            var c = {height: 300}, d = a(this), e = getOptionsJson(d);
            e = setId(this, e), e = a.extend(c, e), UE.delEditor(e.id);
        ...
        }), a('[data-toggle="topjui-ueupload"]').each(function (b) {
            var c = a(this), d = getOptionsJson(c), e = {
                width: 450,
                buttonText: "选择图片",
                uploadType: "image",
                buttonIcon: "icon-picture_add"
            }, d = a.extend(e, d), f = d.id + "Uploader";
            a("body").append('<script type="text/plain" id="' + f + '"></script>');
            var g = UE.getEditor(f, {toolbars: [["insertimage", "attachment"]]});
            g.ready(function () {
                g.setDisabled(), g.hide();
                var b = "afterConfirmUploadedFile", e = "url";
                "image" == d.uploadType && (b = "afterConfirmUploadedImage", e = "src"), g.addListener(b, function (b, c) {
                    a("#" + d.id).textbox("setText", c[0][e]), a("#" + d.id).textbox("setValue", c[0][e]), "src" == e && a("#" + d.previewImageId).attr(e, c[0][e])
            ...
            var c = a(this), d = getOptionsJson(c);
            d.items && (d.items = d.items.replaceAll("'", "").replaceAll(" ", "").split(",")), d.afterUpload && (d.afterUpload = d.afterUpload.toFunc()), d.afterSelectFile && (d.afterSelectFile = d.afterSelectFile.toFunc()), d.confirmSelect && (d.confirmSelect = d.confirmSelect.toFunc());
            var e = {
                font: [],
                ...
                var g = KindEditor.uploadbutton({
                    ...
                    afterUpload: function (b) {
                        if (0 === b.error) {
                            ...
                            a("#" + d.fieldId).textbox("setText", c), a("#" + d.fieldId).textbox("setValue", c), refreshGrid(d.grid.type, d.grid.id)
    ...
    }), a(document).on(topJUI.eventType.initUI.base, function (b) {
        a('[data-toggle="topjui-timeaxis"]').each(function (b) {
            ...
            }), d.columns = [e], c.attr("id", d.id), a("#" + d.id).iTreegrid(d)
        }), a('[data-toggle="topjui-datagrid"]').each(function (b) {
            var c = a(this), d = getOptionsJson(c), e = {initCreate: !0};
            ...
            var c = a(this), d = getOptionsJson(c), e = c.find("thead:first")[0];
            if (a(e).attr("frozen")) {
                var e = [];
                c.find("thead:first th").each(function (a) {
                    e.push(strToJson("{" + this.getAttribute("data-options") + "}"))
            ...
            var b = a(this), c = getOptionsJson(b);
            b.attr("id", c.id), a("#" + c.id).iTabs(c)
        }), a('[data-toggle="topjui-menu"]').each(function () {
            var b = a(this), c = getOptionsJson(b);
            c.id = getRandomNumByDef(), a(this).attr("id", c.id), a(this).iMenu(c)
        }), a('[data-toggle="topjui-menubutton"]').each(function () {
            var b = a(this), c = getOptionsJson(b);
            c.id = getRandomNumByDef(), a(this).attr("id", c.id), a(this).iMenubutton(c)
        }), a('[data-toggle="topjui-splitbutton"]').each(function () {
            var b = a(this), c = getOptionsJson(b);
            c.id = getRandomNumByDef(), a(this).attr("id", c.id), a(this).iSplitbutton(c)
        }), a('[data-toggle="topjui-uploader"]').each(function () {
            var b = a(this), c = getOptionsJson(b);
            c.hasDownArrow = !1, a(this).menubutton(c);
            var d, e, f, g = "pending", h = 0, i = !1, j = '<div id="uploaderDialog"><div id="upfileGrid-toolbar" data-options="border:false"><div style="float: left;margin-right:5px;"><div id="chooseFile">选择文件</div></div><a id="startUpload" style="margin-right:5px;">开始上传</a><a id="removeFile">移除文件</a></div><table id="upfileGrid"></table></div>';
            a("body").append(j + '<div id="uploaderDialog-buttons" style="display:none"><a href="#" id="closeUploaderDialog">关闭</a></div>'), e = a("#upfileGrid").datagrid({
                fit: !0,
                fitColumns: !0,
                rownumbers: !0,
                nowrap: !0,
                ...
                beforeSendFile: function (b) {
                    ...
                    return (new WebUploader.Uploader).md5File(b, 0, 10485760).progress(function (a) {
                        ...
                        a.ajax({
                            ...
                            })) : (a.extend(d.options.formData, {md5: f}), c.resolve())
                        }, function (a, b, d) {
                            c.resolve()
                        })
                    }), a.when(c)
                ...
                e.datagrid("insertRow", {index: 0, row: c})
            }), d.on("uploadProgress", function (a, b) {
                e.datagrid("updateRow", {index: e.datagrid("getRowIndex", a.id), row: {progress: (100 * b).toFixed(2)}})
                ...
                a("#removeFile").linkbutton("disable"), e.datagrid("updateRow", {
                    index: e.datagrid("getRowIndex", b.id),
                    row: {fileState: "上传成功"}
                }), i = !0
            }), d.on("uploadError", function (a) {
                e.datagrid("updateRow", {index: e.datagrid("getRowIndex", a.id), row: {fileState: "上传失败"}})
            ...
            var k = function () {
                ...
                for (var f = 0; f < b.length; f++) {
                    ...
                    d.removeFile(b[f].fileId, !0), e.datagrid("deleteRow", g)
                }
                e.datagrid("clearSelections")
            }, l = function (b, c) {
                return b.getFiles().length <= 0 ? void a.messager.alert("提示", "没有上传的文件!", "error") : void("uploading" === g ? b.stop() : (b.option("formData", {puuid: c.uuid}), b.upload()))
            };
            b.on("click", function () {
                ...
                c = a.extend(h, c), g.dialog({
                    title: c.dialog.title,
                    width: c.dialog.width,
                    height: c.dialog.height,
                    maximized: c.dialog.maximized,
                    maximizable: c.dialog.maximizable,
                    buttons: c.dialog.buttons
                }), g.dialog("open"), a("#startUpload").linkbutton({
            ...
            var b = a(this), c = getOptionsJson(b);
            bindMenuClickEvent(b, c), a(this).iSubMenubutton(c)
        }), a('[data-toggle="topjui-dialog"]').each(function () {
            var b = a(this), c = getOptionsJson(b), d = b.attr("href");
            void 0 != d && (c.href = d, a("body").append('<div id="' + c.id + '"></div>'), a("#" + c.id).iDialog(c), b.on("click", function () {
                return a("#" + c.id).dialog("open"), !1
            }))
        }), a('[data-toggle="topjui-linkbutton"]').each(function (b) {
            var c = a(this), d = getOptionsJson(c);
            c.iLinkbutton(d)
        })
    }), a(document).on(topJUI.eventType.initUI.base2, function (b) {
    ...
    }), a(document).on(topJUI.eventType.initUI.echarts, function (b) {
        a('[data-toggle="topjui-echarts"]').each(function (b) {
            var c = a(this), d = getOptionsJson(c);
            c.iEcharts(d)
        })
    }), a(document).on(topJUI.eventType.initUI.advanceSearchForm, function (b) {
    ...
    }), a(document).on(topJUI.eventType.initUI.importExcelForm, function (b) {
        setTimeout(function () {
    ...
    $(this).trigger(topJUI.eventType.initUI.base), $(this).trigger(topJUI.eventType.initUI.base2), $(this).trigger(topJUI.eventType.initUI.form), $(this).trigger(topJUI.eventType.initUI.echarts), setTimeout(function () {
        ...
        $.ajax({
            ...
            error: function (a) {
                showMessage({statusCode: 300, title: "操作提示", message: a})
            }
        })
    })
}), function (a) {
    function b(b) {
        var d = a(b), e = d.children("input[type=radio]"), f = "";
        e.each(function () {
            var b = a(this), d = a("<span/>").css(c.span), g = a("<label/>").css(c.label), h = a("<a/>").data("lable", g).addClass("RadioA").css(c.radio).text(" "), i = b.data("lable", g).attr("label");
            b.hide(), b.after(g.text(i)), b.wrap(d), b.before(h), b.prop("checked") && (f = h), g.click(function () {
                !function (b) {
                    b.prop("checked", !0), e.each(function () {
                        var b = a(this), c = "-32px";
                        b.prop("checked") && (c = "0"), b.prev().css("background-position", c + " 0")
                    })
                }(b)
            }), h.click(function () {
    ...
    var c = {
        ...
        span: {float: "left", display: "block", margin: "9px 4px 7px 4px"},
        label: {
            marginTop: "9px",
            marginRight: "8px",
            marginBottom: "9px",
    ...
    a.fn.iRadio = function (c, d) {
        return "string" == typeof c ? a.fn.iRadio.methods[c](this, d) : (c = c || {}, this.each(function () {
            if (a.data(this, "radio")) {
                ...
                a.data(this, "radio", {options: a.extend({}, d, c)})
            } else a.data(this, "radio", {options: a.extend({}, a.fn.iRadio.defaults, c)}), b(this)
        }))
    }, a.fn.iRadio.methods = {
        getValue: function (a) {
            var b = a.find("input:checked"), c = {};
            return b.length && (c[b[0].name] = b[0].value), c
        }, check: function (a, b) {
        ...
        inputEvents: a.extend({}, a.fn.combo.defaults.inputEvents, {
            blur: function (b) {
                var c = b.data.target, d = a(c).iRadio("options");
                console.log(c), console.log(d), (d.reversed || d.limitToList) && (d.blurTimer && clearTimeout(d.blurTimer), d.blurTimer = setTimeout(function () {
                    var b = a(c).parent().length;
                    b && (d.reversed ? a(c).iRadio("setValues", a(c).iRadio("getValue")) : d.limitToList && doEnter(c), d.blurTimer = null)
                }, 50))
            }
        })
    }, a.parser && a.parser.plugins && a.parser.plugins.push("iRadio")
}(jQuery), function (a) { // iTabs
    a.fn.iTabs = function (b, c) {
        ...
        onSelect: function (b, c) {
            var d = a(this).iTabs("options"), e = (d.tab, d.parentGrid), f = a("#" + d.id).tabs("getTab", c), g = f.panel("options");
            if (null != g.href || null != g.iframeHref) {
                ...
                i.length > 0 ? a("#" + g.id).children('[data-toggle="topjui-datagrid"]').each(function (b) {
                    var c = a(this), d = getOptionsJson(c), f = d.url;
                    d.url = "", a(this).iDatagrid(d);
                    var h = a("#" + d.id);
                    "object" == typeof e && setGridQueryParams(e, "datagrid", d.id), h.datagrid("options").url = f, h.datagrid("load"), g.dgOpts = d
                }) : "object" == typeof g.dgOpts && ("object" == typeof e && setGridQueryParams(e, "datagrid", g.dgOpts.id), a("#" + g.dgOpts.id).datagrid("reload")), a("#" + g.id).children('[data-toggle="topjui-form"]').each(function (b) {
